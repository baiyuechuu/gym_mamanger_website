...
class AuthManager {
    ...
    showSuccessMessage() {
        ...
        messageDiv.className = 'fixed top-4 right-4 z-50 px-6 py-4 rounded-lg shadow-lg transition-all duration-300 transform translate-x-full bg-green-500 text-white';
    ...
    showLogoutMessage() {
        const messageDiv = document.createElement('div');
        messageDiv.className = 'fixed top-4 right-4 z-50 px-6 py-4 rounded-lg shadow-lg transition-all duration-300 transform translate-x-full bg-blue-500 text-white';
        messageDiv.innerHTML = `
            <div class="flex items-center space-x-2">
